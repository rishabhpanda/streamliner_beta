...
def display_metadata(metadata):
    ...
    std_dev_df = pd.DataFrame(list(metadata['Operational Metadata']['Standard Deviation'].items()), columns=["Column Name", "Std Dev"])
    min_value_df = pd.DataFrame(list(metadata['Operational Metadata']['Minimum Value'].items()), columns=["Column Name", "Min"])
    max_value_df = pd.DataFrame(list(metadata['Operational Metadata']['Maximum Value'].items()), columns=["Column Name", "Max"])
    number_of_zeros_df = pd.DataFrame(list(metadata['Operational Metadata']['Number of Zeros'].items()), columns=["Column Name", "No. of Zeros"])
